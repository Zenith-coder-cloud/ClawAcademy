      ...
      <div className="w-full max-w-sm bg-zinc-900/80 backdrop-blur-xl rounded-2xl p-8 flex flex-col gap-3 shadow-2xl shadow-black/50 relative z-10">
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22.05 1.577c-.393-.016-.784.08-1.117.235-.484.186-4.92 1.902-9.41 3.64L5.11 8.082c-.26.1-.733.3-.763.493-.03.2.168.38.404.502l3.768 1.69c.144.065.31.073.464.027l2.66-.93c.614-.215 1.21-.433 1.79-.64.235-.084.47-.168.697-.252.06-.022.12-.043.173-.065.02-.008.037-.013.038-.013.072-.025.15-.04.22-.012a.312.312 0 0 1 .166.152c.03.06.038.13.02.197-.02.07-.065.13-.12.178l-.018.015c-.058.048-.12.094-.178.14l-3.07 2.51c-.33.27-.5.69-.455 1.12l.46 4.54c.025.254.14.49.327.67.187.18.434.29.696.31.26.02.52-.05.73-.2l2.15-1.55c.49-.35 1.1-.35 1.59 0l3.36 2.51c.29.22.65.33 1.01.31.36-.02.7-.17.96-.42.26-.25.42-.58.47-.94l2.87-16.19c.08-.46.02-.93-.18-1.33a1.62 1.62 0 0 0-.97-.82Z" fill="white"/>
          </svg>

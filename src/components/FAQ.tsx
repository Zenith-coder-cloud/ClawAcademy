...
const faqs = [
  ...
  },
  {
    ...
    a: "Genesis (блоки 0–2) — от нуля до первых результатов. Pro (все 6 блоков) — полный курс + AI ментор Zenith Junior. Elite — всё из Pro + прямой чат с создателем + кастомный агент под твой проект (строго 50 мест).",
  },
  {
